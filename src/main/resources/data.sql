...
insert into shipping (id, customer_id, state, send_date, arrive_date, priority)
            values ( 1,1, 'Entregado', CURRENT_DATE -  INTERVAL 5 DAY, CURRENT_DATE, 0);
insert into shipping (id, customer_id, state, send_date, arrive_date, priority)
            values (2, 2, 'En camino', CURRENT_DATE - INTERVAL 1 DAY, null, 2);
insert into shipping (id, customer_id, state, send_date, arrive_date, priority)
            values (3, 3, 'Inicial', CURRENT_DATE, null, 2); 
            
insert into shipping (id, customer_id, state, send_date, arrive_date, priority)
            values (4, 3, 'Cancelado', CURRENT_DATE - INTERVAL 4 DAY, null, 2);            
